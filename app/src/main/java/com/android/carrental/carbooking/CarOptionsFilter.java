...
public class CarOptionsFilter extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_cars = findViewById(R.id.search_car);
        date_selector = findViewById(R.id.date_selector);
        start_time_selector = findViewById(R.id.start_time);
        end_time_selector = findViewById(R.id.end_time);
        car_type_selector = findViewById(R.id.car_type_selector);
        car_type = findViewById(R.id.car_type_selector);
        car_stations_spinner_filter = findViewById(R.id.car_stations_spinner_filter);
