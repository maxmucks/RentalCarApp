...
public class CarBookingDashboard extends AppCompatActivity implements View.OnClickListener {
   ...
   // private TextView card_number;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirm_booking = findViewById(R.id.btn_booking_confirmation);
        rate = findViewById(R.id.rate_on_booking_confirmation);
        car_name = findViewById(R.id.car_name_for_booking_confirmation);
        date = findViewById(R.id.date_on_booking_confirmation);
        start_time = findViewById(R.id.start_time_on_booking_confirmation);
        end_time = findViewById(R.id.end_time_on_booking_confirmation);
        pickup = findViewById(R.id.pickup_location_on_booking_confirmation);
