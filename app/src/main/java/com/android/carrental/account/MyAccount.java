...
public class MyAccount extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name_on_my_account = findViewById(R.id.name_on_account);
        email_on_my_account = findViewById(R.id.email_on_account);
        phone_on_my_account = findViewById(R.id.phone_on_account);
        street_on_my_account = findViewById(R.id.street_on_account);
        apt_on_my_account = findViewById(R.id.apt_on_account);
        city_on_my_account = findViewById(R.id.city_on_account);
        zip_on_my_account = findViewById(R.id.zip_on_account);
        edit_my_account = findViewById(R.id.edit_details);
